    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                // , {field: 'object_id', title: '对象编号', width: '',sort: true}
                , {field: 'object_name', title: '对象名称', width: ''}
                , {field: 'object_type', title: '对象类型', width: ''}
                , {field: 'action', title: '行为', width: '',}
                , {field: 'user_token', title: '访问者令牌', width: '',}
                , {field: 'create_time', title: '创建时间', width: '', sort: true}
        ...
        var $ = layui.$, active = {
            ...
            exportData: function (){
                ...
                window.location = "{{url('/admin/ObjectDataExport')}}?start_time="+start_time+'&end_time='+end_time;
            }
        };
