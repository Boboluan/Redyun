        ...
        <form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="product_type" name="chinese_name" required="" lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="buy_link" name="english_name" required="" lay-verify=""
                           autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="stock" name="cas" required="" lay-verify=""
                           autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="mac" name="mac" required="" lay-verify=""
                           autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="twa" name="twa" required="" lay-verify=""
                           autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="stel" name="stel" required="" lay-verify=""
                           autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="recommend" name="recommend" required="" lay-verify=""
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="status" value="1"  lay-filter="status"  title="显示" checked>
                    <input type="radio" name="status" value="0"  lay-filter="status"  title="隐藏" >
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio"   name="is_mask" value="true" lay-filter="is_mask" title="口罩" checked>
                    <input type="radio"  name="is_mask" value="false" lay-filter="is_mask" title="面罩">
                </div>
            </div>
            ...
            <div class="layui-form-item" id="maskbox">
                ...
                <div class="layui-input-inline" style="width: 80%">
                    <select name="masktype_one" xm-select="selectId1">
                        ...
                        @foreach($data['mask'] as $vo)
                            <option value="{{$vo['id']}}">{{$vo['product_type']}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 80%">
                        <select name="filtercover_one" xm-select="selectId4">
                            ...
                            @foreach($data['filtercover'] as $vo)
                                <option value="{{$vo['id']}}">{{$vo['product_type']}}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 80%">
                        <select name="cottonfilter_one" xm-select="selectId5">
                            <option value="" disabled="disabled">请选择滤棉过滤棉</option>
                            @foreach($data['cottonfilter'] as $vo)
                                <option value="{{$vo['id']}}">{{$vo['product_type']}}</option>
                            @endforeach
                        </select>
                    </div>
